...
public partial class EntityMotion
{
    ...
    public sealed class Mechanism() : EntityMotion
    {
        ...
        private protected override Kind Type => Kind.Mechanism;

        internal static new Mechanism Read(EndianReader reader, FormatProfile profile)
        {
            var motion = new Mechanism
            {
                Movement = (Sequence)reader.ReadByte(),
                Loop = (LoopBehavior)reader.ReadByte(),
        ...
        internal static void Write(Mechanism value, EndianWriter writer, FormatProfile profile)
        {
            writer.Write((byte)value.Movement);
            writer.Write((byte)value.Loop);
        ...
        /// <summary>
        /// Defines the motion movement sequence, axis operation, and mechanical execution order for a <see cref="Mechanism"/>.
        /// </summary>
        ...
        /// <summary>
        /// Defines the motion movement axis and mechanical travel path for a <see cref="Mechanism"/>.
        /// </summary>
        ...
        /// <summary>
        /// Flags controlling looping, repetition, and return-to-start behavior for a <see cref="Mechanism"/>.
        /// </summary>
        [Flags]
