...
public partial class EntityMotion
{
    ...
    /// </summary>
    public sealed class MovePoint() : EntityMotion
    {
        /// <summary>
        /// Flags controlling how this motion travels between move points.
        /// </summary>
        public PauseBehavior Pause { get; set; }
        ...
        private protected override Kind Type => Kind.MovePoint;

        /// <remarks>
        /// Not read here - <see cref="EntityMotion.Read"/> sets it from the shared Motion block header,
        /// not from this motion's own fields.
        /// </remarks>
        internal static new MovePoint Read(EndianReader reader, FormatProfile _) => new()
        {
            Pause = (PauseBehavior)reader.ReadUInt32(),
            MovePointId = reader.ReadAssetId(),
            Speed = reader.ReadSingle(),
        };

        internal static void Write(MovePoint value, EndianWriter writer, FormatProfile _)
        {
            writer.Write((uint)value.Pause);
        ...
        /// </summary>
        [Flags]
        public enum PauseBehavior : uint
        {
            /// <summary>
            /// No flags are set.
            /// </summary>
