...
internal static class AssetCodecs
{
    ...
    private static void RegisterConcreteCodecs()
    {
        ...
        Register(AssetType.AttackTable, AttackTableAsset.Read, AttackTableAsset.Write, AttackTableAsset.SupportedGames);
        Register(AssetType.Boulder, BoulderAsset.Read, BoulderAsset.Write, BoulderAsset.SupportedGames);
        Register(AssetType.Button, ButtonAsset.Read, ButtonAsset.Write, ButtonAsset.SupportedGames);
        ...
        Register(AssetType.Conditional, ConditionalAsset.Read, ConditionalAsset.Write, ConditionalAsset.SupportedGames);
        Register(AssetType.Counter, CounterAsset.Read, CounterAsset.Write, CounterAsset.SupportedGames);
        ...
        Register(AssetType.DashTrack, DashTrackAsset.Read, DashTrackAsset.Write, DashTrackAsset.SupportedGames);
        Register(AssetType.DestructibleAsset, DestructibleAsset.Read, DestructibleAsset.Write, DestructibleAsset.SupportedGames);
        ...
        Register(AssetType.Group, GroupAsset.Read, GroupAsset.Write, GroupAsset.SupportedGames);
        ...
        Register(AssetType.MovePoint, MovePointAsset.Read, MovePointAsset.Write, MovePointAsset.SupportedGames);
        Register(AssetType.NavigationMesh, NavigationMeshAsset.Read, NavigationMeshAsset.Write, NavigationMeshAsset.SupportedGames);
        ...
        Register(AssetType.Text, TextAsset.Read, TextAsset.Write, TextAsset.SupportedGames);
        Register(AssetType.ThrowableTable, ThrowableTableAsset.Read, ThrowableTableAsset.Write, ThrowableTableAsset.SupportedGames);
        Register(AssetType.Timer, TimerAsset.Read, TimerAsset.Write, TimerAsset.SupportedGames);
        Register(AssetType.Trigger, TriggerAsset.Read, TriggerAsset.Write, TriggerAsset.SupportedGames);
