...
public partial class UIMotionCommand
{
    ...
    /// </summary>
    public sealed class Rotate : UIMotionCommand
    {
        ...
        /// <inheritdoc/>
        public override Command Type => Command.Rotate;

        private protected override int FieldsSize => 12;

        internal static new Rotate Read(EndianReader reader, FormatProfile _) => new()
        {
        ...
        internal static void Write(Rotate value, EndianWriter writer, FormatProfile _)
        {
