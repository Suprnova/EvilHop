...
public partial class UIMotionCommand
{
    ...
    /// </summary>
    public sealed class Scale : UIMotionCommand
    {
        ...
        /// <inheritdoc/>
        public override Command Type => Command.Scale;

        private protected override int FieldsSize => 20;

        internal static new Scale Read(EndianReader reader, FormatProfile _)
        {
            var value = new Scale
            {
        ...
        internal static void Write(Scale value, EndianWriter writer, FormatProfile _)
        {
