...
public partial class UIMotionCommand
{
    ...
    /// </summary>
    public sealed class UVScroll : UIMotionCommand
    {
        ...
        /// <inheritdoc/>
        public override Command Type => Command.UVScroll;

        private protected override int FieldsSize => 8;

        internal static new UVScroll Read(EndianReader reader, FormatProfile _) => new()
        {
            AmountU = reader.ReadSingle(),
            AmountV = reader.ReadSingle(),
        };

        internal static void Write(UVScroll value, EndianWriter writer, FormatProfile _)
        {
