...
public partial class UIMotionCommand
{
    ...
    /// </summary>
    public sealed class AbsoluteScale : UIMotionCommand
    {
        ...
        /// <inheritdoc/>
        public override Command Type => Command.AbsoluteScale;

        private protected override int FieldsSize => 20;

        internal static new AbsoluteScale Read(EndianReader reader, FormatProfile _)
        {
            var value = new AbsoluteScale
            {
        ...
        internal static void Write(AbsoluteScale value, EndianWriter writer, FormatProfile _)
        {
