...
public partial class UIMotionCommand
{
    ...
    /// </summary>
    public sealed class Opacity : UIMotionCommand
    {
        ...
        /// <inheritdoc/>
        public override Command Type => Command.Opacity;

        private protected override int FieldsSize => 4;

        internal static new Opacity Read(EndianReader reader, FormatProfile _)
        {
            var value = new Opacity
            {
        ...
        internal static void Write(Opacity value, EndianWriter writer, FormatProfile _)
        {
