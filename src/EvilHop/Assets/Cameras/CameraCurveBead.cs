...
public sealed class CameraCurveBead
{
    ...
    internal static CameraCurveBead Read(EndianReader reader, FormatProfile _) => new()
    {
    ...
    internal static void Write(CameraCurveBead value, EndianWriter writer, FormatProfile _)
    {
