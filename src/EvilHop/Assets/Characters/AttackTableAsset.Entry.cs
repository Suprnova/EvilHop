...
public partial class AttackTableAsset
{
    ...
    /// the owning table's <see cref="States"/>.
    /// </summary>
    public sealed class Entry
    {
        /// <summary>
        /// A hash identifying the <see cref="States"/> entry (or the entity's animation
        ...
        /// <summary>
        /// The index into the owning <see cref="AttackTableAsset"/>'s <see cref="Transitions"/>
        /// where this entry's range begins, mirroring how <see cref="Section.Start"/> ranges
        /// over <see cref="Entries"/>.
        /// </summary>
        public ushort Start { get; set; }

        /// <summary>
        /// The number of <see cref="Transitions"/> in this entry's range, starting at
        /// <see cref="Start"/>.
        /// </summary>
