...
/// </remarks>
public sealed class NPCSettingsAsset() : Asset(AssetType.NPCSettings), Physical.INPCSettingsAsset
{
    ...
    public override Physical.INPCSettingsAsset Physical => this;

    private uint? _overriddenParameterCount;
    uint Physical.INPCSettingsAsset.ParameterCount
    {
...
public static partial class Physical
{
    ...
    /// </summary>
    public interface INPCSettingsAsset : IAsset
    {
        /// <summary>
