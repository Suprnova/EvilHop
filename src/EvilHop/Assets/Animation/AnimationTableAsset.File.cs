...
public partial class AnimationTableAsset
{
    ...
    public sealed class File
    {
        ...
        internal static File Read(EndianReader reader, FormatProfile _) => new()
        {
            Flags = (Behavior)reader.ReadUInt32(),
        ...
        internal static void Write(File value, EndianWriter writer, FormatProfile _)
        {
        ...
        /// <summary>
        /// Flags governing the playback and blending of an <see cref="File"/>.
        /// </summary>
        [Flags]
