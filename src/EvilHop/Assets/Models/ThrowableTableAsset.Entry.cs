...
public partial class ThrowableTableAsset
{
    ...
    public sealed class Entry
    {
        ...
        internal static Entry Read(EndianReader reader, FormatProfile _, int version)
        {
            var row = new Entry
            {
        ...
        internal static void Write(Entry value, EndianWriter writer, FormatProfile _, int version)
        {
