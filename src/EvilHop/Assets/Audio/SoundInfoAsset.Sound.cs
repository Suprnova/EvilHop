...
public partial class SoundInfoAsset
{
    ...
    public sealed class Sound
    {
        ...
        internal static Sound Read(EndianReader reader, FormatProfile _) => new()
        {
            SoundAssetId = reader.ReadAssetId(),
            Flags = (Identity)reader.ReadByte(),
            SampleIndex = reader.ReadByte(),
            SoundBankIndex = reader.ReadByte(),
            SoundInfoIndex = reader.ReadByte(),
        };

        internal static void Write(Sound entry, EndianWriter writer, FormatProfile _)
        {
        ...
        /// <summary>Flags for one <see cref="Sound"/>.</summary>
        [Flags]
