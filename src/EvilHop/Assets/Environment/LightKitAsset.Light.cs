...
public partial class LightKitAsset
{
    ...
    /// <see cref="Shape.Ambient"/> light, all four are <see cref="Vector3.Zero"/>.
    /// </remarks>
    public sealed class Light
    {
        ...
        /// <summary>
        /// The direction a <see cref="Shape.Directional"/> light points towards, as an angle
        /// throughout the level rather than a position.
        /// </summary>
        public Vector3 At { get; set; }

        /// <summary>
        /// This light's world position, for <see cref="Shape.Point"/> and
        /// <see cref="Shape.Spot"/> lights.
        /// </summary>
        ...
        /// non-<see cref="Shape.Ambient"/> light type.
        /// </summary>
        public float PositionW { get; set; }

        /// <summary>
        /// The radius of a <see cref="Shape.Point"/> or <see cref="Shape.Spot"/>
        /// light.
        /// </summary>
        public float Radius { get; set; }

        /// <summary>
        /// The cone angle of a <see cref="Shape.Spot"/> light.
        /// </summary>
        public float Angle { get; set; }

        internal static Light Read(EndianReader reader, FormatProfile _)
        {
            var light = new Light
            {
                Type = (Shape)reader.ReadUInt32(),
        ...
        internal static void Write(Light value, EndianWriter writer, FormatProfile _)
        {
        ...
        /// <summary>
        /// Defines the lighting type of a <see cref="Light"/>.
        /// </summary>
