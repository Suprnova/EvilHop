...
public partial class ShrapnelAsset
{
    ...
    public sealed class Fragment
    {
        ...
        public FragmentKind Kind { get; set; }
        ...
        internal static Fragment Read(EndianReader reader, FormatProfile profile)
        {
            var type = (FragmentKind)reader.ReadUInt32();
            ...
            int totalFragSize = type == FragmentKind.Inactive
        ...
        internal static void Write(Fragment frag, EndianWriter writer, FormatProfile _)
        {
            writer.Write((uint)frag.Kind);
