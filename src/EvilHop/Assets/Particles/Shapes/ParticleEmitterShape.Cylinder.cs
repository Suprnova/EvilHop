...
{
    /// <summary>
    /// A <see cref="ParticleEmitterShape"/> for <see cref="ParticleEmitterAsset.ShapeKind.VCylEdge"/>. Not used in
    /// <see cref="GameVersion.N100F"/>.
    /// </summary>
    public sealed class Cylinder : ParticleEmitterShape
    {
        ...
        internal static Cylinder Read(EndianReader reader, FormatProfile _) => new()
        {
