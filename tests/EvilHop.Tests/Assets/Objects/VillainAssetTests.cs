...
public class VillainAssetTests
{
    ...
    [Fact]
    public void Read_ThenWrite_VillainWithoutEntityPaddingOrTaskWidgetSecondId_ReproducesInputBytes()
    {
        ...
        var profile = BFBBSerializer.DefaultProfile with { EntityHasPadding = false, VillainHasTaskWidgetSecondId = false };
