...
public class BoulderAssetTests
{
    ...
    [Fact]
    public void Read_ThenWrite_BoulderWithoutEntityPaddingOrSoundFalloff_ReproducesInputBytes()
    {
        ...
        var profile = BFBBSerializer.DefaultProfile with { EntityHasPadding = false, BoulderHasSoundFalloff = false };
