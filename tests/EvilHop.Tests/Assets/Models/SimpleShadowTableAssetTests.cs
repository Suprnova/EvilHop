...
public class SimpleShadowTableAssetTests
{
    ...
    public void Write_SimpleShadowTableAsset_UnderN100F_StillWritesItsOwnFields()
    {
        ...
        asset.Entries.Add(new SimpleShadowTableAsset.Entry { ModelId = new AssetId(1), ShadowModelId = new AssetId(2), Unknown = 1 });
    ...
    public void Read_SimpleShadowTable_CountKeepsDerivingAfterMutation()
    {
        ...
        asset.Entries.Add(new SimpleShadowTableAsset.Entry());
