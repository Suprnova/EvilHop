...
public class PipeInfoTableAssetTests
{
    ...
    public void Read_PipeInfoTable_UnderBfbb_PopulatesEveryField()
    {
        ...
        Assert.Equal(PipeInfoTableAsset.LightingMode.LightKitOnly, first.Flags.LightingMode);
        Assert.Equal(PipeInfoTableAsset.CullMode.Unknown, first.Flags.CullMode);
        Assert.Equal(PipeInfoTableAsset.ZWriteMode.Disabled, first.Flags.ZWriteMode);
    ...
    public void Read_PipeInfoTable_UnderTSSM_PopulatesLayerAndAlphaDiscard()
    {
        ...
        Assert.Equal(PipeInfoTableAsset.RenderingLayer.PreLastFx, first.Layer);
        Assert.Equal(0x80, first.AlphaDiscard);

        var second = asset.Entries[1];
        Assert.Equal(PipeInfoTableAsset.RenderingLayer.PrePtank, second.Layer);
    ...
    public void Count_DisagreeingWithEntries_IsStoredIndependently()
    {
        ...
        asset.Entries.Add(new PipeInfoTableAsset.Entry());
    ...
    {
        var flags = new PipeInfoTableAsset.RenderBehavior(initial).WithAlphaCompare(expected);
    ...
    {
        var flags = new PipeInfoTableAsset.RenderBehavior(0)
