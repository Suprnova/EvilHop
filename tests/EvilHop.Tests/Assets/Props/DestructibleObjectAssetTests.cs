...
public class DestructibleObjectAssetTests
{
    ...
    public void Read_DestructibleObject_UnderBfbb_PopulatesEveryField()
    {
        ...
        Assert.Equal(DestructibleObjectAsset.DamageSource.PatrickSlam | DestructibleObjectAsset.DamageSource.Throw, asset.HitFlags);
        Assert.Equal(2, asset.CollisionType);
        Assert.Equal(DestructibleObjectAsset.Effect.Dust, asset.FxType);
    ...
    [Fact]
    public void Read_ThenWrite_DestructibleObjectWithoutEntityPaddingOrSwapEffects_ReproducesInputBytes()
    {
        // BFBB's leftover gl/Working and gl/New Folder archives predate the entity padding and
        ...
        var profile = BFBBSerializer.DefaultProfile with { EntityHasPadding = false, DestructibleObjectHasSwapEffects = false };
